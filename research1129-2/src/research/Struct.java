...
public final class Struct {
	...
	/*public LinkedList<Long> getAccentMp1() {
		return accentMp1;
	}

	public LinkedList<Long> getAccentMp2() {
		return accentMp2;
	}

	public LinkedList<Long> getAccentMp3() {
		return accentMp3;
	}

	public LinkedList<Long> getAccentMp4() {
		return accentMp4;
	}
	public LinkedList<Long> getWhatAccentMp(int i) {
		if (i == 1) return accentMp1;
		else if (i == 2) return accentMp2;
		else if (i == 3) return accentMp3;
		else return accentMp4;
	}
*/
